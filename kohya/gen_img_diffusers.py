...
from .tools import original_control_net as original_control_net
...
class PipelineLike:
    ...
    def enable_xformers_memory_efficient_attention(self):
        ...
        self.unet.set_use_memory_efficient_attention(True, True)
...
def main(args):
    ...
    if args.network_module:
        ...
        for i, network_module in enumerate(args.network_module):
            ...
            imported_module = importlib.import_module("kohya."+network_module)
        ...
        def process_batch(batch: List[BatchData], highres_fix, highres_1st=False):
            ...
            if highres_fix and not highres_1st:
                ...
                if upscaler:
                    ...
                    # 返回值为PIL.Image.Image或torch.Tensor的潜空间
            ...
            # 不管在批处理中的位置如何，为了使用相同的随机数，在这里生成随机数。一起检查image/mask在batch内是否相同
            ...
            for i, (image, prompt, negative_prompts, seed, clip_prompt) in enumerate(
                ...
                if args.use_original_file_name and init_images is not None:
                    ...
                    fln = f"apple_{highres_prefix}{step_first + i + 1:06d}.png"
                else:
                    fln = f"apple_{ts_str}_{highres_prefix}{i:03d}_{seed}.png"
