...
def get_args():
    ...
    args = {
        ...
        "overwrite": False,
        "dirname_pattern": 'dataset\{username}',
        "filename_pattern": '{index}_{filename}.{ext}',
        "inline_filename_pattern": '{index}_{filename}_inline.{ext}',
        "other_filename_pattern": '[{id}]_{filename}.{ext}',
